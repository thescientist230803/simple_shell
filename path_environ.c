 ...
 * Returns: pointer to path member string or NULL if not found
 */
...
/**
 * pathexctract - exctracts path member from environ PATH
 *
 * @path: pointer to PATH
 * @Returns: pointer to exctracted path member
 */
...
/**
 * _fullpathbuffer - combines the path to the first argument entered by user
 *
 * @av: points to an array of arguments entered by the user
 * @path_member: points to a path member from path variable in environ
 * Returns: an array of characters pointing to a file which exists and can be executed
 */
